...
const OWNER = {
  ...
  blurb:
    "I build self-hosted Windows desktop software — applications that install and run entirely on your own machine, with no account to create and no data leaving it.",
};
...
const PRODUCTS = [
  {
    ...
    tagline:
      "Your bank statements, turned into something you can actually read.",
    summary:
    ...
    requirements: [
      ...
      [
        "Database",
        "None to install — PostgreSQL 18 is bundled and runs embedded",
      ],
    ...
    sections: [
      {
        ...
        blurb:
          "Every figure on these pages is derived from parsed statement rows — nothing is entered by hand.",
        plates: [
          [
            "01-overview",
            "Overview",
      ...
      },
      {
        id: "activity",
        eyebrow: "Activity",
        title: "Down to the individual row",
      ...
      },
      {
        id: "planning",
        eyebrow: "Planning",
        title: "Forward-looking, not just historical",
        blurb:
          "Commitments the app tracks against what the statements actually show.",
        plates: [
          [
            "08-budgets",
            "Budgets",
      ...
      },
      {
        id: "card",
        eyebrow: "Credit card",
        title: "Cards get their own model",
        blurb:
          "A credit card statement is not a bank statement — billing cycles, a minimum due and a limit have no equivalent in a savings account, so these surfaces exist only for card accounts.",
        plates: [
          [
            "13-credit-card",
            "Card overview",
      ...
      },
      {
        ...
        blurb:
          "Three banks, four file formats. Parsers are registered per bank and extension, with content-sniffing as a fallback when the pairing is unfamiliar.",
        plates: [
          [
            "11-upload",
            "Upload a statement",
      ...
      },
      {
        id: "dark",
        eyebrow: "Dark mode",
        title: "Both themes, equally",
        blurb:
          "Themes are token-level — chart colours are read from the same CSS custom properties as the rest of the UI, so plots recolour with the page instead of staying stuck in a light-mode palette.",
        plates: [
